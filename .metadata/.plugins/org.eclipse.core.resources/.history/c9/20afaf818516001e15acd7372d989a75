...
int main(){
	...
	while(1){
		...
		I2C_MasterSendData(&I2C1Handle, &commandCode[0], 1, SLAVE_ADDR, I2C_ENABLE_SR);
		// Length stored
		I2C_MasterReceiveData(&I2C1Handle, &messageLenght, 1, SLAVE_ADDR, I2C_ENABLE_SR);

		// Send second command to get the message
		I2C_MasterSendData(&I2C1Handle, &commandCode[1], 1, SLAVE_ADDR, I2C_ENABLE_SR);
		// Receive the message
		I2C_MasterReceiveData(&I2C1Handle, message, messageLenght, SLAVE_ADDR, I2C_DISABLE_SR);
