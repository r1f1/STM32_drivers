...
/*
 * Get this function from the startup code
 * This is the function that the processor will execute when an IRQ number is selected
 * In the vector table is the address where this function is located?
 */
