...
typedef struct{
	uint8_t GPIO_PinNumber;						/* Valid pin numbers from @GPIO_PIN_NUMBERS */
	uint8_t GPIO_PinMode;						/* Possible values from @GPIO_PIN_MODES */
	uint8_t GPIO_PinSpeed;						/* Possible values from @GPIO_PIN_SPEED */
	uint8_t GPIO_PinPuPdControl;				/* Possible values from @GPIO_PIN_PUPD */
	uint8_t GPIO_PinOPType;						/* Possible values from @GPIO_PIN_OP_TYPE */
	uint8_t GPIO_PinAltFunMode;					/* Possible values form @GPIO_PIN_ALTFN */
...
#define GPIO_MODE_IT_FT				4			/* Interrupt event falling trigger */
#define GPIO_MODE_IT_RT				5			/* Interrupt event rising trigger */
#define GPIO_MODE_IT_RFT			6			/* Interrupt event falling-rising trigger */
...
#define GPIO_SPEED_V_HIGH 			3			/* Very high speed */

/*
 * @GPIO_PIN_PUPD
 * GPIO pin possible pull-up/pull-down resistor
 */
...
/*
 * @GPIO_PIN_ALTFN
 * GPIO pin possible alternate function
 */
